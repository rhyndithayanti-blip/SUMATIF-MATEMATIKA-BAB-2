...
const STORAGE_QUESTIONS_KEY = 'sd3_matematika_pecahan_kelas4_v1';
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    try {
      ...
      if (saved) {
        ...
        // Pastikan jumlah dan struktur sesuai dengan distribusi soal (20 soal: 10 PG, 5 PGK, 5 PGK Kategori)
